...
<h3> <?php echo $_SESSION['username'];?><br> Personal Data</h3>
<fieldset>
<br>
<?php
    $username = $_SESSION['username'];
...
<th width="30%">Name</td>     &nbsp &nbsp  &nbsp  &nbsp  &nbsp  <?php echo ':'?>    <?php echo ucwords (strtolower($row['name'])); ?>  <br>  
<th width="30%">Address</td>     &nbsp  &nbsp &nbsp <?php echo ':'?>    <?php echo ucwords (strtolower($row['address'])); ?><br>
<th width="10%">Telephone</td>   &nbsp  <?php echo ':'?>    <?php echo $row['phoneNo']; ?><br>
<th width="10%">Email</td>   &nbsp &nbsp  &nbsp &nbsp&nbsp  <?php echo ':'?>    <?php echo $row['email']; ?><br>
<th width="10%">Level</td>       &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp   <?php echo ':'?>    <?php echo $row['level_id']; ?><br>
<br><br>
<td width="10%" align="center"><a class="one" href="update_user.php?username=<?php echo $row['username'];?>">Edit</a></td>
