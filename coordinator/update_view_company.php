...
<div class="sign">
  ...
  //connect to db
    ...
    $q="select * from company_detail";
    $res=mysqli_query($dbconn,$q);

    echo "<tr><th>ID.</th><th>Company Name</th><th>Company Address</th><th>Company Email</th><th>Company Phone No.</th><th>Action</th></tr>\n";
while($r=mysqli_fetch_assoc($res)){
    echo "<tr><td>".$r['comp_id']."</td><td>".$r['comp_name']."</td><td>".$r['comp_address']."</td><td>".$r['comp_email']."</td><td>".$r['comp_phoneNo']."</td><td><a class='edit-btn' href='update_company.php?comp_id=".$r['comp_id']."'>Edit</class=>  <a class='delete-btn' href='delete_company.php?comp_id=".$r['comp_id']."'>Delete</a></td></tr>\n";
}
